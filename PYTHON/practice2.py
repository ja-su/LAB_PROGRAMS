...
def reservationtraina():
        ...
        for i in range(x):
          ...
          cls()
          if(z==1):
              mainreservation(name,age,gender,train1,booking,clas,datefirst,tvc,trvl,ers,tcr,t1)
          elif(z==2):
              mainreservation(name,age,gender,train1a,bookinga,clas,datesecond,tvc,trvl,ers,tcr,t1)
          elif(z==3):
              mainreservation(name,age,gender,train1b,bookingb,clas,datethird,tvc,trvl,ers,tcr,t1)
          else:
              print("\n \t Inaccurate") 
              time.sleep(2)
...
def reservationtrainb():
        ...
        for i in range(x):
          ...
          cls()
          if(z==1):
              mainreservation(name,age,gender,train2,booking1,clas,datefirst,tcr,srr,clt,ksq,t2)
          elif(z==2):
              mainreservation(name,age,gender,train2a,booking1a,clas,datesecond,tcr,srr,clt,ksq,t2)
          elif(z==3):
              mainreservation(name,age,gender,train2b,booking1b,clas,datethird,tcr,srr,clt,ksq,t2)
          else:
            print(" \n \t Inaccurate") 
            time.sleep(2)
...
def reservationtrainc():
        ...
        for i in range(x):
          ...
          z=int(input(" \n \t Enter your choice : "))
          if(z==1):
              mainreservation(name,age,gender,train3,booking2,clas,datefirst,ksq,srr,ers,tvc,t3) 
          elif(z==2):
              mainreservation(name,age,gender,train3a,booking2a,clas,datesecond,ksq,srr,ers,tvc,t3)
          elif(z==3):
              mainreservation(name,age,gender,train3b,booking2b,clas,datethird,ksq,srr,ers,tvc,t3)
          else:
              print("\n \t Inaccurate") 
              time.sleep(2)
